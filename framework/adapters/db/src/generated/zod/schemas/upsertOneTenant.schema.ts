...
export const TenantUpsertOneSchema: z.ZodType<Prisma.TenantUpsertArgs> = z.object({ select: TenantSelectObjectSchema.optional(),  where: TenantWhereUniqueInputObjectSchema, create: z.union([ TenantCreateInputObjectSchema, TenantUncheckedCreateInputObjectSchema ]), update: z.union([ TenantUpdateInputObjectSchema, TenantUncheckedUpdateInputObjectSchema ]) }).strict() as unknown as z.ZodType<Prisma.TenantUpsertArgs>;

export const TenantUpsertOneZodSchema = z.object({ select: TenantSelectObjectSchema.optional(),  where: TenantWhereUniqueInputObjectSchema, create: z.union([ TenantCreateInputObjectSchema, TenantUncheckedCreateInputObjectSchema ]), update: z.union([ TenantUpdateInputObjectSchema, TenantUncheckedUpdateInputObjectSchema ]) }).strict();