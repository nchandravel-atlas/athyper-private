/* ============================================================================
   Athyper — META Layer: Entity Registry, Versioning, Fields, Relations,
             Indexes, Policies, Compiled Snapshots, Policy Framework,
             Workflow Definitions, Overlay System
   PostgreSQL 16+ (pgcrypto)

   Depends on: 010_bootstrap.sql, core.tenant (030_core_foundation.sql)
   NOTE: core.tenant must be created before this file runs.
   ============================================================================ */
...
-- NOTE: References core.operation (defined in 050_core_permissions.sql)
-- ============================================================================
