...
export default function PartnerDashboardPage({ params }: { params: Promise<{ id: string }> }) {
    const { id } = use(params);
...
function DashboardContent({
    ...
    async function handleDuplicateAndEdit() {
        try {
            ...
            window.location.href = `/wb/partner/dashboard/${result.id}/edit`;
        } catch {
        ...
        <div className="p-6">
            <div className="mb-6 flex items-start justify-between">
                ...
                <div className="flex gap-2">
                    ...
                    {canEdit && !isSystem && (
                        <a href={`/wb/partner/dashboard/${id}/edit`}>
