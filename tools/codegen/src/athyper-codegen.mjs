...
const CONTRACTS_GEN_DIR = path.join(REPO_ROOT, "packages", "contracts", "generated", "prisma");
...
async function writeEntryPoints() {
  ...
  const genRoot = path.join(REPO_ROOT, "packages", "contracts", "generated");
  ...
  // Contracts side re-export (optional convenience)
  const contractsGenIndex = path.join(REPO_ROOT, "packages", "contracts", "src", "generated", "index.ts");
